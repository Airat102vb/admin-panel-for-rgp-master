...
public class PlayerControllerTest {
    ...
    public void updatePlayerTest() throws Exception {
        ...
        putPlayerResponse.setBirthday(631929600000L);
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/rest/players/1")
                ...
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.id").value(1))
                .andExpect(MockMvcResultMatchers.jsonPath("$.name").value(putPlayerResponse.getName()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.title").value(putPlayerResponse.getTitle()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.race").value(putPlayerResponse.getRace().toString()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.profession").value(putPlayerResponse.getProfession().toString()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.birthday").value(putPlayerResponse.getBirthday()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.banned").value(putPlayerResponse.getBanned()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.experience").value(putPlayerResponse.getExperience()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.level").value(1))
                .andExpect(MockMvcResultMatchers.jsonPath("$.untilNextLevel").value(50));
    }
